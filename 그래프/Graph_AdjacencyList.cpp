...
Graph_AdjacencyList::Graph_AdjacencyList(GraphOption graphOption, size_t size)
	: Graph(graphOption)
{
	m_capacity = size;
...
bool Graph_AdjacencyList::AddNode(string name)
{
...
void Graph_AdjacencyList::AddEdge(string from, string to, int weight)
{
...
/// <returns>성공 여부</returns>
bool Graph_AdjacencyList::RemoveNode(string name)
{
...
/// <param name="from">시작 노드</param>
/// <param name="to">끝 노드</param>
void Graph_AdjacencyList::RemoveEdge(string from, string to)
{
	size_t fromIdx{ GetNodeIndex(from) }, toIdx{ GetNodeIndex(to) };
...
/// 그래프를 초기화한다.
/// </summary>
void Graph_AdjacencyList::Clear()
{
	Graph::Clear();
...
/// 해시 테이블의 현 상태를 출력한다.
/// </summary>
void Graph_AdjacencyList::PrintGraph(GraphTraversal graphTraversal, string graphName)
{
...
/// 그래프의 크기를 두배로 늘린다.
/// </summary>
void Graph_AdjacencyList::Resize()
{
...
/// BFS로 그래프를 출력한다.
/// </summary>
void Graph_AdjacencyList::PrintGraphBFS(size_t nodeIdx)
{
	bool* nodeChecker = new bool[m_capacity] {};
	queue<size_t> q;
	q.push(nodeIdx);
...
/// DFS로 그래프를 출력한다.
/// </summary>
void Graph_AdjacencyList::PrintGraphDFS(size_t nodeIdx)
{
	bool* nodeChecker = new bool[m_capacity] {};
	stack<size_t> s;
	s.push(nodeIdx);
